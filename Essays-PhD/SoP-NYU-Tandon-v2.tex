...
Majoring in Financial Engineering at \NJU, I began my research journey in my sophomore year, when I co-authored the report series China's Low-Carbon Transformation of The Power System at the \TCJC. I was exposed to the energy markets and REC trading in some depth for the first time. In Spring 2024, I had the privilege to be the sole exchange student from my university to study at \CU, where I stood at the top in \SC’s grad-level class, 'Applied Stochastic Processes'. It was Prof. Campbell who opened me the door to stochastic optimization in PA-MFGs problems by taking me as his RA. Under his supervision, I renovated a \textbf{Deep FBSDE Solver} to model the \textbf{multi-period compliance MFG in the REC markets}. With greater numeric stability, the renovated solver modeled how the defaultable agents responded to different penalty policies, their interactions, and market impacts\footnote{The results are summarized in \Report and made open-source on \GitHubMFG.}. This experience only made me eager to dig deeper into PA-MFG, while recognizing there were still many fundamental things to learn.

Upon back to China, I interned as a quant researcher in the high-freq stock trading group at \Higgs. I developed a \textbf{Peer Grouping System} by using the \textbf{Affinity Propagation} and \textbf{XGBoost} to identify top-correlated stock pairs as “peers”, providing a data-driven alternative for the industry grouping that’d be more tailored to high-freq strategies. Compared to the benchmark (i.e. industry), this system tripled the prediction power of most of high-freq technical factors. Resonating with this, I contributed to the research project \InsurP, mentored by the actuary \CA and \LX, training K-Means to identify risk clusters and customizing exposure rating models for each cluster. This innovative insurance policy pricing strategy has not yet been implemented in the industry. These industry experiences not just echoed with each other (in terms of clustering algorithms), but also reinforced my understanding of the research process - it was the tremendous amount of (failed) experiments and attempts that could ultimately bring the creative ideas to life, no matter in the industry or academia. This is why I believe the PhD research training at Tandon will benefit whatever I choose as a future career.

Another big reason why I think of Tandon as the choice for me lies in its resources in my field of interest and its emphasis on the co-evolution of the industry and academic world. As mentioned before, I am especially interested in stochastic controls, the PA-MFG, and their application in energy markets. After thorough research, I realized that Prof. Nizar Touzi is a veteran in this specific field, digging really deep into it for decades (provided a prototype for the discretization approach used in our Deep FBSDE Solver back in 2004). Meanwhile, should I have a chance to pick up Prof. Renyuan Xu’s expertise in deep learning and generative models, I might help bring new perspectives to the theoretical SDEs analysis. Most impressively, NYU Tandon is also the only top program with industry professors (to my knowledge), whose real-world insights will make my research work more practical and thus meaningful.


Consequently, upon completing my PhD at NYU Tandon, my 5-year goal is first to gain real-world experience in the green energy market, while contributing my research work to an efficient market design. Afterward, I will commit myself to bridging academia and industry, passing on my experience to the younger talents. 
