...
My determination to pursue a PhD in the field of stochastic control and optimization is a natural outcome of my academic exploration and industry experiences. Echoing each other, these experiences ignited my great interest in \textbf{SDEs, Principle-Agent problem, and stochastic game}, especially their application in \textbf{green energy markets}. Grad studies at \schoolShort would be my first step toward my long-term goal of a research-driven career in multiple dynamic fields.

Majoring in Financial Engineering at \NJU, I began my research journey in my sophomore year, when I co-authored the report series China's Low-Carbon Transformation of The Power System at the \TCJC, which introduced me to the dynamics of REC trading and sparked my interest in renewable energy markets. In Spring 2024, I had the privilege to be the sole exchange student from my university to study at \CU, where I ranked at the top in \SC’s grad-level class, \textit{Applied Stochastic Processes}. Prof. Campbell opened the door to stochastic optimization in PA-MFG problems by taking me on as his RA. Under his supervision, I enhanced a Deep FBSDE Solver to model multi-period compliance MFG in REC markets\footnote{The results are summarized in \Report and made open-source on \GitHubMFG.}. This renovation increased the solver’s numerical stability, enabling it to model how defaultable agents respond to varying penalty policies, their interactions, and market impacts. Through these experiences, I came to appreciate the transformative role of deep learning in addressing PA-MFG models, a direction I am excited to pursue further in my PhD studies.

At the same time at Columbia, I also contributed to the research project \textbf{\InsurP}, mentored by the actuary \CA and \LX, training K-Means to identify risk clusters and customizing exposure rating models for each cluster - an innovative pricing approach that has yet to be implemented in the industry. This experience laid a strong foundation in clustering-based techniques, which I later applied as a quant researcher in the high-freq stock trading group at \Higgs. In this role, I developed a \textbf{Peer Grouping System} by using the \textbf{Affinity Propagation} and \textbf{XGBoost} to identify top-correlated stock pairs as “peers”, providing a data-driven alternative for the industry grouping that is better suited for high-freq strategies. Compared to the benchmark (i.e. industry), this system tripled the prediction power of most of high-freq technical factors. Both experiences not only echoed each other technically but also deepened my understanding of the research process. I learned that extensive experimentation is what ultimately brings creative ideas to life, whether in industry or academia. This is why I believe that PhD research training at Tandon will be invaluable, honing the research skills that will support me in any career path I pursue.

Another major reason I see NYU Tandon as the ideal choice is its emphasis on the co-evolution of industry and academia, as well as its extensive resources in my areas of interest—stochastic controls, PA-MFG, and their applications in energy markets. Through my research, I’ve found that Prof. Nizar Touzi stands out for his deep expertise in theoretical analysis, with decades of dedicated work in this specific field of PA-MFG with dynamic programming. On the applied side, I greatly admire Prof. Renyuan Xu, whose focus on deep learning and generative models strongly aligns with my interests. Working under the guidance of both would enable me to contribute fresh perspectives to stochastic optimization. Additionally, I find it inspiring that NYU Tandon is, to my knowledge, the only top program with industry professors - their insights would make my research not only innovative but also highly practical.


Consequently, upon completing my PhD at NYU Tandon, my 5-year goal is first to gain real-world experience in the green energy market, while contributing my research work to efficient market design. Afterward, I will commit myself to bridging academia and industry, sharing my experience and knowledge with those new to this field.


In summary, I believe I bring with me research experience, industry-sharpened programming and soft skills, and above all, a deeply inquisitive nature that drives me to learn and excel. I look forward to the next milestone in my life – a PhD in FRE(ECE) at NYU Tandon.
