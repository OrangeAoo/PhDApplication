...
\subsection{Nanjing University \normalfont \hfill B.A. - Financial Engineering \hfill 2021-2025}
...
\begin{itemize}
    \item \textbf{GPA}: 4.17/4.33
\end{itemize}

\section{Relevant Courses}
\begin{itemize}
    % \item \begin{description}
    %     \item[Statistics] **DS in Finance And Insurance (Python) (A+), Statistical Machine Learning (A), Python, Applied Statistics II: Time Series (Python), *Financial Engineering, *\hypertarget{FinTS}{Financial Time Series} (R), *Artificial Intelligence, *Data Mining
    % \end{description}
    
    \item\begin{description}
        \item[CS] **DS in Finance And Insurance (Python) (A+), Statistical Machine Learning (A), Python, Applied Statistics II: Time Series (Python), *Financial Engineering, *\hypertarget{FinTS}{Financial Time Series} (R), *Artificial Intelligence, *Data Mining
    \end{description}
    
    \item\begin{description}
        \item[Math] **Stochastic Processes(A+), Numerical Analysis and Application Software (MATLAB), Calculus, Discrete Mathematics(93, top), Linear Algebra, ODE, *PDE, *Financial Mathematics
    \end{description}
    % \item\begin{description}
    %     \item[Finance] Econometrics, Financial Risk Management, Securities Investment, Corporate Finance, Microeconomics, Macroeconomics, *Options Investing, Accounting(100)
    % \end{description} 
...
\begin{itemize}
    \item \begin{description}
        ...
        \begin{itemize}
            ...
            \item Offshore wind industry’s role in the low-carbon transition - the current bottlenecks and prospects
        \end{itemize}
    \end{description}
    \item \begin{description}
